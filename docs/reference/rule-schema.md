...
The canonical Go shape is `api.Rule` in [`internal/api/rule.go`](https://github.com/vilaca/portal/blob/main/internal/api/rule.go). The CRD spec ([`internal/rule/v1alpha1/types.go`](https://github.com/vilaca/portal/blob/main/internal/rule/v1alpha1/types.go)) is a verbatim mirror except for the engine-internal `Source` field.
...
When loaded from a `PortalClusterRule` / `PortalRule` CR, the reconciler writes a `.status` block per rule ([`internal/rule/v1alpha1/types.go`](https://github.com/vilaca/portal/blob/main/internal/rule/v1alpha1/types.go) `RuleStatus`):
