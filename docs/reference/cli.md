...
* [portal completion](#portal-completion)	 - Generate the autocompletion script for the specified shell
* [portal init-certs](#portal-init-certs)	 - Generate webhook TLS material and inject the CA bundle into the ValidatingWebhookConfiguration
* [portal migrate-rules](#portal-migrate-rules)	 - Convert podwatcher-poc SpEL rules into Portal expr-lang rules
* [portal run](#portal-run)	 - Run Portal (admission webhook, audit loop, network analyser)
...
* [portal](#portal)	 - Portal — Kubernetes admission, audit, NetworkPolicy and response-action engine
* [portal completion bash](#portal-completion-bash)	 - Generate the autocompletion script for bash
* [portal completion fish](#portal-completion-fish)	 - Generate the autocompletion script for fish
* [portal completion powershell](#portal-completion-powershell)	 - Generate the autocompletion script for powershell
* [portal completion zsh](#portal-completion-zsh)	 - Generate the autocompletion script for zsh
