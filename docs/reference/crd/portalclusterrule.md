...
> Normally regenerated from the CRD OpenAPI schema (`crd-ref-docs` or similar). The Go types live in [`internal/rule/crd/types.go`](../../../internal/rule/crd/types.go); the YAML CRD is shipped in `deploy/helm/portal/crds/`.
...
Written by the status reconciler in [`internal/rule/crd/`](../../../internal/rule/crd/). All fields are optional.
